...
public class Programa {
	...
	public static void main(String[] args) {		
		//N�o foi implementada funcionalidade para adicionar novo cliente e vendedor atraves do Scanner
		Comprador cliente1 = new Comprador("Jo�o", "111.222.333-45", 0.00, 0.00, 0);
		...
		//Loja nesse contexto cont�m os registros dos clientes e vendedores
